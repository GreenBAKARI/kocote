...
<html>
    ...
    <center>
        ...
        <body topmargin="100" bottommargin="100">
            ...
            <!-- イベント分類ボタンの表示 -->
            <div id = "box">
                <a href="../search/search_event.php?category=0"><img src="../img/ev_all.jpg" height="18%" width="8%"></a>
                <a href="../search/search_event.php?category=1"><img src="../img/ev_gf.jpg" height="18%" width="8%"></a>
                <a href="../search/search_event.php?category=2"><img src="../img/ev_ge.jpg" height="18%" width="8%"></a>
                <a href="../search/search_event.php?category=3"><img src="../img/ev_ks.jpg" height="18%" width="8%"></a>
                <a href="../search/search_event.php?category=4"><img src="../img/ev_ft.jpg" height="18%" width="8%"></a>
                <a href="../search/search_event.php?category=5"><img src="../img/ev_sc.jpg" height="18%" width="8%"></a>
            </div>
            <br><br>
    </center>
